...
+ (instancetype)makeWithPlayerId:(NSInteger)playerId {
  FVPStartPictureInPictureMessage *pigeonResult =
      [[FVPStartPictureInPictureMessage alloc] init];
  pigeonResult.playerId = playerId;
  return pigeonResult;
}
+ (FVPStartPictureInPictureMessage *)fromList:(NSArray<id> *)list {
...
+ (instancetype)makeWithPlayerId:(NSInteger)playerId {
  FVPStopPictureInPictureMessage *pigeonResult =
      [[FVPStopPictureInPictureMessage alloc] init];
  pigeonResult.playerId = playerId;
  return pigeonResult;
}
+ (FVPStopPictureInPictureMessage *)fromList:(NSArray<id> *)list {
